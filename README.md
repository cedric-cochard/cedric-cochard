...
<body>
  <section>
  <h1 align="center">SEO && Web and Mobile Web Developer</h1>
  <h3 align="center">Specialized in natural referencing, SEO, I trained in Web Development & Mobile Web - React Specialization, at O ​​'clock in order to have a 360 vision.</br> My goal is to design websites that meet current standards based on accessibility, performance and security. 🎯 </br>
  In order to make them visible, I like to challenge web semantics on search engines to support it towards constant optimization.</h3>
