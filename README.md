...
<body>
  <section>
  <h1 align="center">SEO && Développeur Web et Web Mobile</h1>
  <h3 align="center">Spécialisé en référencement naturel, SEO, je me suis formé au Développement Web & Web Mobile - Spécialisation React, chez O 'clock afin d'avoir une vision 360.</br> Mon but est de concevoir des sites web qui répondent aux normes actuelles basées sur l'accessibilité, la performance et la sécurité. 🎯 </br>
  Afin de les rendre visibles, j'aime challenger la sémantique web sur les moteurs de recherche pour l'accompagner vers une constante optimisation.</h3>
  ...
  <a href="https://babeljs.io/" target="blank" rel="noreferrer"> <img src="https://www.vectorlogo.zone/logos/babeljs/babeljs-icon.svg" alt="babel" width="40" height="40"/> </a> 
